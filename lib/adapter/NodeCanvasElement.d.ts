...
import type { ICanvasRenderingContext2D, ContextSettings, ICanvas, ICanvasRenderingContext2DSettings } from 'pixi.js';
...
export declare class NodeCanvasElement implements ICanvas {
    ...
    getContext(contextId: 'webgpu', options?: ContextSettings | NodeCanvasRenderingContext2DSettings): null;
    /**
     ...
     */
    addEventListener(type: string, listener: EventListenerOrEventListenerObject): EventEmitter<string | symbol, any>;
    /**
     * Removes the listener for the specified event.
     * @param type - The type of event to listen for.
     * @param listener - The callback to invoke when the event is fired.
     */
    removeEventListener(type: string, listener: EventListenerOrEventListenerObject): EventEmitter<string | symbol, any>;
    /**
